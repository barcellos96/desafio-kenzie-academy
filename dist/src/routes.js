...
const validateContactCreate_middleware_1 = __importDefault(require("./middlewares/validateContactCreate.middleware"));
//USER
...
//CONTACTS
routes.post("/users/contacts/:id", authUser_middleware_1.authUser, validateUserId_middleware_1.default, validateContactCreate_middleware_1.default, contactCreate_controller_1.default);
